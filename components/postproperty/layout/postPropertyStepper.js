...
const PostPropertyStepper = ({ currentPage }) => {
  ...
  return (
    <div
      className={` ${styles.postprop_stepper_main_container} d-flex flex-column align-items-center justify-content-center   ${styles.stepper_bg_color}`}
    >
      <div>
