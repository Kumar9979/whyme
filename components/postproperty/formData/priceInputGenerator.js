...
const PriceInputGenerator = ({ price = true, placeholder = "Enter Your Maintanence Fee", title, itemName, formikValue, formik }) => {
    return (
        price ?
            ...
            >
                ...
                <div className={`${styles.propetyfeature_input} w-100 d-flex`}  >
                    ...
                    >
                        <span className={`${styles.input_bar} mx-2`}></span>
                        <span
                            className={`fontFam_poppins fw_500 align-middle me-3`}
                        >
                            Sqft
                        </span>
                    </div>
