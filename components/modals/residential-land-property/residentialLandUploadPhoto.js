...
const ResidentialLandUploadPhoto = ({ show, handleClose, handleImageUpload }) => {
          ...
          <div className="mt-2">
            ...
            >
              {({
                ...
                <div {...dragProps} className={`${styles.upload_image} ms-2`}>
                  <div>
                    <div
                      htmlFor="upload"
...
export default ResidentialLandUploadPhoto;
