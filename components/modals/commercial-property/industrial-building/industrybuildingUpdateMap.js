...
const IndustryBuildingUpdateMap = ({ show, handleClose }) => {
  return (
    <Modal
      centered
      show={show}
      ...
      <Modal.Body>
        ...
        <div className="px-lg-2 ">
          ...
          <div className={`d-flex justify-content-end`}>
            <button
              onClick={handleClose}
              className={`${styles.save_btn} px-4 px-lg-5 py-lg-2 py-1 fs_15 mt-3`}
            >
              <span>Save</span>
            </button>
          </div>
...
export default IndustryBuildingUpdateMap;
