    ...
    <div className="mt-5">
      <div className={`${styles.review_container} mt-5`}>
        <div className="  d-flex align-items-center ">
         <div><span className={`${styles.reviewtext} fw_500 me-lg-3 me-md-3  me-sm-3 me-1 `}>
            Review & Rating
          </span></div>
          <div className="  d-flex align-items-center mt-lg-1 mt-md-1 mt-sm-1 mt-1 ">
          <Image src={star} alt="Picture of the author"   />
          <span className={`${styles.reviewrating_number}  fs_24 fw_400 ms-lg-1  ms-md-1 ms-sm-1 ms-0`}>
            4.7
            <span
        ...
        <div className={`mt-lg-4 mt-md-3 mt-sm-3 mt-3  d-flex align-items-center `}>
            ...
            {stars.map((_, index) => {
              return (
                <FaStar
                  ...
                  onClick={() => handleClick(index + 1)}cls
                        ...
                        <div className="  ">
                          <div className="d-flex justify-content-start ">
                            ...
                            <div className="ms-lg-2  ms-md-2 ms-sm-2 ms-2  ">
                              <span className= {`${styles.profilename} fs_24 fw_500 fontFam_poppins`}>
                                Rohit
                              </span>
                              <br />
                              <div className="d-flex align-items-center ">
