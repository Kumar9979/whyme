  ...
  return (
    <div className="d-flex h-100 flex-column">
      <ul className="list-unstyled">
        <li className="mt-3">
          <h1
            className={`fs_18 fw_500 fontFam_poppins  ${styles.searched_dates} py-2  mb-3`}
          >
            Yesterday
          </h1>
          <ul
            className={`${styles.property_location} list-unstyled ms-lg-4 ms-1 fs_18 fw_600 fontFam_poppins  px-4 px-lg-0`}
          >
        ...
        <li className="mt-3">
          <h1
            className={`fs_18 fw_500 fontFam_poppins  ${styles.searched_dates} py-2 px-2 mb-3`}
          >
            26 Aug 2022
          </h1>
          <ul
