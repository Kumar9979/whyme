...
const PriceDetailsSell = () => {
  ...
  return (
<<<<<<< HEAD:pages/post-property/price-details/priceDetails.js
...
=======
    ...
    <div
      className={`${styles.priceDetails_boxShadow} d-flex justify-content-center align-items-center col-lg-6 p-5`}
    >
>>>>>>> a1ba204a1836beee1c63168c94c0625db4f50f5a:pages/post-property/price-details/priceDetailsSell.js
      {/* <div>stepper</div> */}
