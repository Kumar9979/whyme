                ...
                <div className={`${Styles.carbody} `}>
                  <div className="card-body ms-5 mt-4">
                    ...
                    <img
                      ...
                      className={`${Styles.mapimage} pe-5 pt-4 w-100 `}
                    />
                        ...
                        >
                          ...
                          <span className=" ">
                            {/* <Image
                              src={Image1}
                              alt="Picture of the author"
                              className={` ${Styles.buttonicon} me-2`}
                              width={15}
                              height={15}
                            /> */}
                      ...
                      <div className="mt-5 ms-3">
                        ...
                        >
                          ...
                          <span className="ms-5 ">
                            ...
                            /> */}
                            <i
                              className={`${Styles.icon_arrowRightbtn} h-100 p-1 ri-arrow-right-line text-white border-light border mt-1 rounded `}
                            ></i>
                          </span>
                        </button>
                      </div>
