...
import RequestCall, { CompanyRequestCall, PostedByOwner } from "../../../../components/property-details/request-callback";
    ...
    <div>
      <div className={`${styles.body_background} pb-5`}>
        <div className="row d-flex justify-content-center">
          <div className="col-lg-7 col-11">
            <ImageGrid propertyType="1200Sqft Commercial Shop in Vijayanagar, Mysuru" />
            <Aboutproperty data={3} />
            <Amenties data={3} />
            <ContactOwner />
            <PropertyLocation />
      ...
      >
        <div className="col-lg-7">
          <OtherProperties amenties = {1} type = "1200Sqft Commercial Shop in Vijaynagar..." data={1} plot={3} />
        </div>
