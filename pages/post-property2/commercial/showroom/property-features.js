...
const propertyFeatures = () => {
  ...
  function handleMainRoad(e) {
    setMainRoad(e.target.value);
    let event = {
      target: {
        name: "mainRoad",
        value: e.target.value,
            ...
            <div className={`${styles.input_container}`}>
              ...
              <form onSubmit={formik.handleSubmit}>
                <div className={`${styles.propertyFeature_padding_l_res}`}>
                  ...
                  >
                    <div className="row gx-4  w-100 mb-4 mb-lg-0">
                    ...
                    <div className="col-4 mb-4 mb-lg-3">
                      ...
                      <div className="d-flex mt-3">
                        <input
                          ...
                          type="radio"
                          value="yes"
                          checked={mainRoad === "yes"}
                          onChange={handleMainRoad}
                        />
                        <label
                          htmlFor="yes"
                          className={
                    ...
                    <div className={`${styles.amenities_list_flex_res}`}>
                      ...
                      >
                        <input
                          className="form-check-input rounded-0 mt-2"
                          type="checkbox"
                          id="Car/ Vehicle Showroom"
                          name="Car/ Vehicle Showroom"
                          onChange={handleCheckbox}
                          checked={formik.values.Amenities.includes(
                    ...
                    <div className={`${styles.amenities_list_flex_res}  `}>
                      ...
                      >
                        <input
                          ...
                          type="checkbox"
                          id="Restaurant/ Diners"
                          name="Restaurant/ Diners"
                          onChange={handleCheckbox}
                          checked={formik.values.Amenities.includes(
                            "Restaurant/ Diners"
                          )}
                      ...
                      >
                        <input
                          className="form-check-input rounded-0 mt-2"
                          type="checkbox"
                          id="Multi Bran Showroom"
                          name="Multi Bran Showroom"
                          onChange={handleCheckbox}
                          checked={formik.values.Amenities.includes(
                            "Multi Bran Showroom"
                          )}
                    ...
                    <div className={`${styles.amenities_list_flex_res}  `}>
                      ...
                      >
                        <input
                          className="form-check-input rounded-0 mt-2"
                          type="checkbox"
                          id="Fashion Apparel Showroom"
                          name="Fashion Apparel Showroom"
                          onChange={handleCheckbox}
                          checked={formik.values.Amenities.includes(
                        ...
                        <label
                          className={`form-check-label mt-1 text-nowrap ${styles.font_medium}  ${styles.fontFam_poppins} ${styles.amenities_list_title}`}
                          htmlFor="Fashion Apparel Showroom"
                        >
                          Fashion Apparel Showroom
                        </label>
                      </div>
